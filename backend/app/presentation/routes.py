...
from app.infrastructure.repositories import InMemoryRepository, MongoRepository
...
try:
    ...
    logging.warning(f"Failed to connect to MongoDB, falling back to InMemoryRepository: {e}")
